...
public class Constants {
	 ...
	 * Flag for dev mode. <code>true</code> if the app is deployed to common.dev.sense-os.nl.
	 */
	public static final boolean DEV_RC_MODE = GWT.getModuleBaseURL().contains("rc.dev.sense-os.nl");
	/**
	 * Flag for local mode. <code>true</code> if the app is deployed to an unknown location.
	 */
	public static final boolean GENERIC_MODE = !STABLE_MODE && !RC_MODE && !DEV_MODE
			&& !DEV_RC_MODE;
